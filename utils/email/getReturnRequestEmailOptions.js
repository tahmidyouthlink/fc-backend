const getReturnRequestEmailOptions = (
  email,
  fullName,
  returnItems,
  additionalNote
  ...
  const options = {
    ...
    to: email,
    subject: `[${process.env.COMPANY_NAME}] We've Received Your Return Request`,
    text: `HI ${fullName.toUpperCase()}!

      We've received your return request. We'll get back to you soon.
      ...
      Your Additional Note: "${additionalNote}"
          ...
          <style>
            * {
            ...
            @media (max-width: 670px) {
              ...
              .row-${5 + returnItems.length} .column-1 {
              ...
              .row-${
                5 + returnItems.length
              } .column-1 .block-1.paragraph_block td.pad > div {
                font-size: 16px !important;
              }

              .row-${
                5 + returnItems.length
              } .column-1 .block-2.paragraph_block td.pad > div {
                font-size: 12px !important;
              }
              ...
              <tr>
                <td>
                                    ...
                                    <tr>
                                      ...
                                      >
                                        <div class="alignment" align="center">
                                          ...
                                          >
                                            <img
                                              src="https://9b9bd796c4.imgdist.com/pub/bfra/q6hiwcjj/cvf/gf3/9da/office-work-81.png"
                                              style="
                                                display: block;
                                                height: auto;
                                                border: 0;
                                              ...
                                              "
                                              width="336"
                                              alt="Staff going through the return request"
                                              title="Staff going through the return request"
                                              height="auto"
                                            />
                                          </div>
                                        </div>
                  ...
                  ${returnItems
                                        ...
                                        <td class="pad">
                                          ...
                                          >
                                            <p
                                              style="margin: 0; word-break: break-word"
                                            >
                                              Price: ৳ ${item.price.toLocaleString()}<br />Size: ${
                          item.size
                        }<br />Color: <span
                                                  style="
                    ...
                    .join("")}
                  <table
                    class="row row-${5 + returnItems.length}"
                    align="center"
                    width="100%"
                    border="0"
                    cellpadding="0"
                              ...
                              <tr>
                                <td
                                  ...
                                  style="
                                    ...
                                    font-weight: 400;
                                    text-align: center;
                                    border-bottom: 20px solid #ecf3ea;
                                    border-left: 20px solid #ecf3ea;
                                    border-right: 20px solid #ecf3ea;
                                    border-top: 20px solid #ecf3ea;
                                    padding-bottom: 30px;
                                    padding-left: 20px;
                                    padding-right: 20px;
                                    padding-top: 30px;
...
module.exports = getReturnRequestEmailOptions;
