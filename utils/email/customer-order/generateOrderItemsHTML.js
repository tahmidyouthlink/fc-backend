const generateOrderItemsHTML = (productInformation = []) => {
...
const generateOrderItemsText = (productInformation = []) => {
  return productInformation
    .map((item, index) => {
...
module.exports = { generateOrderItemsHTML, generateOrderItemsText };
