const getResetPasswordEmailOptions = (fullName, email, resetLink) => {
  const options = {
    ...
    text: `Hi ${fullName}!
      ...
      This link will expire in 30 minutes for user account security. If you're still facing issues to reset your password, feel free to contact us at ${
                                    ...
                                    <tr>
                                      ...
                                      >
                                        <div class="alignment" align="center">
                                          ...
                                          >
                                            <img
                                              src="https://9b9bd796c4.imgdist.com/pub/bfra/q6hiwcjj/6f6/27m/cmp/authentication-1-3.png"
                                              style="
                                                display: block;
                                                height: auto;
                                                border: 0;
                                      ...
                                      >
                                        <div class="alignment" align="center">
                                          <a
                                            ...
                                            "
                                            ><!--[if mso]>
                                              <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word"  href="#"  style="height:42px;width:180px;v-text-anchor:middle;" arcsize="10%" fillcolor="#29972d">
                                      ...
                                      <td class="pad">
                                        ...
                                        >
                                          <p
                                            style="margin: 0; word-break: break-word"
                                          >
                                            This link will expire in 30 minutes for
                                            user account security. If you're still
                                            facing issues to reset your password, feel
...
module.exports = getResetPasswordEmailOptions;
